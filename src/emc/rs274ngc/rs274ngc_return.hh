...
#define NCE_MULTIPLE_INIT_WORDS_ON_ONE_LINE _("Multiple INIT words on one line")
#define NCE_LEFT_BRACKET_MISSING_AFTER_INIT _("Left bracket missing after INIT")
#define NCE_COMMA_MISSING_AFTER_INIT_CHANNEL _("Comma missing after INIT channel")
#define NCE_RIGHT_BRACKET_MISSING_AFTER_INIT _("Right bracket missing after INIT")
#define NCE_INVALID_CHANNEL_NUMBER_FOR_INIT _("Invalid channel number for INIT")
...
#define NCE_MULTIPLE_GET_WORDS_ON_ONE_LINE _("Multiple GET words on one line")
#define NCE_MULTIPLE_RELEASE_WORDS_ON_ONE_LINE _("Multiple RELEASE words on one line")
#define NCE_MULTIPLE_GETD_WORDS_ON_ONE_LINE _("Multiple GETD words on one line")
#define NCE_LEFT_BRACKET_MISSING_AFTER_GET _("Left bracket missing after GET/RELEASE")
#define NCE_RIGHT_BRACKET_MISSING_AFTER_GET _("Right bracket missing after GET/RELEASE")
#define NCE_LEFT_BRACKET_MISSING_AFTER_START _("Left bracket missing after START")
#define NCE_RIGHT_BRACKET_MISSING_AFTER_START _("Right bracket missing after START")
#define NCE_MULTIPLE_START_WORDS_ON_ONE_LINE _("Multiple START words on one line")
#define NCE_INVALID_CHANNEL_NUMBER_FOR_START _("Invalid channel number for START")
#endif
